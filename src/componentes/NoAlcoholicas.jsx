...
import nonAlcoholic from './js/apiNonAlcoholic';
...
const NoAlcoholicas = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const initialData = nonAlcoholic;
    ...
    const handleAddToCart = (item) => {
        const productoParaCarrito = {
            ...
            descripcion: item.strCategory || 'Bebida No Alcohólica',
            precio: 10.90,
                ...
                {drinkDetails.map((item) => (
                    <div className="col-md-4 col-sm-12" key={item.idDrink}>
                        <Card
                            ...
                            category={item.strCategory || 'Bebida No Alcohólica'}
